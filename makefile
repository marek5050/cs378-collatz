...
RunCollatz: Collatz.h Collatz.c++ RunCollatz.c++
	$(CC) -pedantic -std=c++11 -Wall Collatz.c++ RunCollatz.c++ -o RunCollatz
...
TestCollatz: Collatz.h Collatz.c++ TestCollatz.c++
	$(CC) -fprofile-arcs -ftest-coverage -pedantic -std=c++11 -Wall Collatz.c++ TestCollatz.c++ -o TestCollatz -lgtest -lgtest_main -lpthread
